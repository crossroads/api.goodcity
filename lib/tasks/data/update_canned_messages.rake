  ...
  namespace :canned_messages do
    ...
    task update_canned_system_messages: :environment do
      canned_response = [{  guid: 'logistics-complete-review-message',
                            name_en: 'logistics.complete_review_message',
                            ...
                            name_en: 'review_offer.close_offer_message',
                            ...
                            name_en: 'review_offer.missing_offer_message',
                            ...
                            name_en: 'review_offer.receive_offer_message',
