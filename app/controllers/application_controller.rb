      ...
      unless jwt_decoded_json.all? &:blank?
        ...
        case cur_time.present?
          ...
          when iat_time > cur_time == true
              throw(:warden, {status: :forbidden, msg: I18n.t('warden.token_invalid'), value: false})
          when exp_time < cur_time == true
              throw(:warden, {status: :forbidden, msg: I18n.t('warden.token_expired'), value: false})
          when iat_time < exp_time == true
              throw(:warden, {status: :forbidden,
                    msg: I18n.t('warden.token_invalid'), value: false})
          else
              throw(:warden, {status: :unauthorized, msg: I18n.t('warden.token_invalid'), value: false})
        end
      else
          throw(:warden, {status: :unauthorized, msg: I18n.t('warden.token_invalid'), value: false})
      end
