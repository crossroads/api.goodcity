  ...
  class OffersController < Api::V1::ApiController
    ...
    def_param_group :offer do
      param :offer, Hash, required: true do
        param :language, I18n.available_locales.map(&:to_s), allow_nil: true, desc: "Offer language. If not set, defaults to API header language."
        param :state_event, Offer.valid_events, allow_nil: true, desc: "Fires the state transition (if allowed) for this offer."
        param :origin, String, allow_nil: true, desc: "Not yet used"
        param :stairs, [true, false], allow_nil: true, desc: "Does offer collection involve using stairs?"
        param :parking, [true, false], allow_nil: true, desc: "Is parking provided?"
        param :estimated_size, String, allow_nil: true, desc: "How big is the item?"
        param :notes, String, allow_nil: true, desc: "Not yet used"
