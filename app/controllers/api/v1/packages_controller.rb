  ...
  module V1
    class PackagesController < Api::V1::ApiController
      ...
      def stockit_item_details
        render json: stock_serializer.new(@package,serializer: stock_serializer,root: "item",include_order: true,include_orders_packages: true,exclude_stockit_set_item: @package.set_item_id.blank?,include_images: @package.set_item_id.blank?,include_allowed_actions: true).as_json
      end
