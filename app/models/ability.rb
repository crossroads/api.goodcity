class Ability
  ...
  PERMISSION_NAMES = ['can_manage_items', 'can_manage_goodcity_requests', 'can_manage_packages',
    'can_manage_offers', 'can_manage_organisations_users', 'can_search_packages',
  ...
  def package_abilities
    ...
    elsif can_search_packages?
      can [:index, :show], Package, Package.browse_in_stock_packages do |record|
