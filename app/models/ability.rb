class Ability
  ...
  PERMISSION_NAMES = %w[
    ...
    can_manage_settings can_manage_companies can_manage_package_detail can_access_printers can_remove_offers_packages can_access_orders_process_checklists can_mention_users
    can_manage_packages_chat
  ].freeze
