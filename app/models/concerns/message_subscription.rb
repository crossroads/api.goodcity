#
# Subscription logic for messages is extracted here to avoid cluttering the model class
module MessageSubscription
  extend ActiveSupport::Concern

  #
  # Who gets notified of a new message
  # If you are subscribed here, you get a new 'unread' message in your inbox
  #   (or a 'read' message if you are the sender).
  def subscribe_users_to_message
    ...
    #   - Donor / Charity user - if offer/order is not cancelled
    #   - Message sender
