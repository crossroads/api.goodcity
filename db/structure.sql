...
--
-- Name: index_orders_on_district_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_orders_on_district_id ON public.orders USING btree (district_id);
...
--
-- Name: orders fk_rails_97308bf2a4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT fk_rails_97308bf2a4 FOREIGN KEY (district_id) REFERENCES public.districts(id);
...
INSERT INTO schema_migrations (version) VALUES ('20181212081321');
